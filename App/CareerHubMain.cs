...
namespace CareerHubApp.App
{
    public class CareerHubMain
    {
        ...
        public CareerHubMain(IDatabaseManager databaseManager)
        {
                ...
                if (int.TryParse(Console.ReadLine(), out choice))
                {
                    switch (choice)
                    {
                        ...
                        case 2:
                            ...
                            break;
                        case 3:
                            Console.WriteLine("Exiting... the build");
                            return;
                        default:
        ...
        private void UserMenu()
        {
            while (true)
            {
                ...
                Console.WriteLine("1. Create Profile for the user");
        ...
        private void CompanyMenu()
        {
            while (true)
            {
                ...
                Console.WriteLine("1. Create New Company Detail");
                Console.WriteLine("2. Post Job Now");
        ...
        private void ApplyForJob()
        {
            ...
            Console.WriteLine("Enter the job ID for the application:");
            int jobID;
        ...
        private void CreateProfile()
        {
            ...
            // Call the createProfile method from _applicantService
